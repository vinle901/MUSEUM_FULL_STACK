    ...
    return (
      <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-8 py-16 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">Browse our gift shop or buy tickets to get started.</p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Link
              to="/tickets/checkout"
              className="inline-block bg-white text-black border-2 border-gray-300 px-8 py-3 rounded-lg font-semibold hover:bg-gray-50 transition-colors"
            >
              Ticket
            </Link>
          </div>
              ...
              {cart.map((item) => {
                ...
                return (
                  <div key={item.item_id} className="bg-white border-2 border-gray-200 rounded-lg p-4 flex gap-4">
                    {/* Image: do not render any image block for ticket items */}
                    ...
                    <div className="flex-1">
                      <div className="flex justify-between items-start mb-2">
                        <div>
                          ...
                          <p className="text-sm text-gray-600">{item.category || (item.cart_type === 'ticket' ? `Tickets • ${item.visit_date || ''}` : '')}</p>
                        </div>
                        <button
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          {typeof item.stock_quantity === 'number' && item.quantity >= item.stock_quantity && (
